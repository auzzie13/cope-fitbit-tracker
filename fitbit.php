...
//                    $this->save();
    ...
    function make_auth_link($module) {
        ...
        // scope
        $fitbit_auth_url .= "&scope=" . rawurlencode("activity%20heartrate%20location%20oxygen_saturation%20profile%20respiratory_rate%20settings%20sleep%20social%20temperature%20weight
        ");
        // redirect_uri
